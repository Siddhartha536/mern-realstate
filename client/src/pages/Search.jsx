...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const fetchListings = async () => {
      setLoading(true);
      // Determine the limit per fetch, e.g., 8
      const limit = 8;
      const currentStartIndex = startIndexFromUrl;

      // Append limit and skip to the query parameters for pagination
      urlParams.set('limit', limit);
      urlParams.set('skip', currentStartIndex);
      ...
      try {
        ...
        if (Array.isArray(data)) {
          // If it's the first fetch, replace listings; otherwise, append
  ...
  const handleSubmit = (e) => {
    ...
    // Reset startIndex for a new search
